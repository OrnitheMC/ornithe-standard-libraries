...
public class WrappedIdRegistry<T> implements ClearableRegistry<T> {
	...
	NamespacedIdentifier serializeKey(String key) {
		return key == null ? null : NamespacedIdentifiers.parse(key);
	}

	String deserializeKey(NamespacedIdentifier identifier) {
	...
	private void valueRegistered(int id, String key, Object value) {
		if (this.frozen) {
	...
	public interface RegisterCallback {
		...
		void valueRegistered(int id, String key, Object value);
