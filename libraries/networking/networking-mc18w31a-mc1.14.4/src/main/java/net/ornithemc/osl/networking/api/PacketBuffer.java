...
public class PacketBuffer extends ByteBuf {
	...
	public byte[] readByteArray(int maxLength) {
		return this.delegate.readByteArray(maxLength);
	}
	...
	public int[] readIntArray(int maxLength) {
		return this.delegate.readIntArray(maxLength);
	}
	...
	public String readString(int maxLength) {
		return this.delegate.readString(maxLength);
	}
	...
	public BlockPos readBlockPos() {
		return this.delegate.readBlockPos();
	}

	public Identifier readIdentifier() {
		return this.delegate.readIdentifier();
	}
	...
	public ByteBuf writeVarLong(long value) {
		return this.delegate.writeVarLong(value);
	}

	public ByteBuf writeByteArray(byte[] bytes) {
		return this.delegate.writeByteArray(bytes);
	}

	public ByteBuf writeIntArray(int[] values) {
		return this.delegate.writeIntArray(values);
	}
	...
	public ByteBuf writeString(String s, int maxLength) {
		return this.delegate.writeString(s, maxLength);
	}

	public ByteBuf writeEnum(Enum<?> value) {
		return this.delegate.writeEnum(value);
	}

	public ByteBuf writeDate(Date date) {
		return this.delegate.writeDate(date);
	}

	public ByteBuf writeUuid(UUID uuid) {
		return this.delegate.writeUuid(uuid);
	}

	public ByteBuf writeBlockPos(BlockPos pos) {
		return this.delegate.writeBlockPos(pos);
	}

	public ByteBuf writeIdentifier(Identifier id) {
		return this.delegate.writeIdentifier(id);
	}
	...
	public ByteBuf writeText(Text text) {
		return this.delegate.writeText(text);
	}
