...
/**
 * Events to track the lifecycle of the Minecraft server.
 * These events do not distinguish between integrated servers
 * of single-player worlds and dedicated servers.
 */
