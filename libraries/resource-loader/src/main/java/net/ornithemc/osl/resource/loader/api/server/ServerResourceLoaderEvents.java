...
public final class ServerResourceLoaderEvents {
	 ...
	 * <pre>
	 * {@code
	 * ServerResourceLoaderEvents.START_RESOURCE_PACKS_RELOAD.register(packRepository -> {
	 * 	...
	 * });
	 * }
	 * </pre>
	 ...
	 * <pre>
	 * {@code
	 * ServerResourceLoaderEvents.END_RESOURCE_PACKS_RELOAD.register(packRepository -> {
	 * 	...
	 * });
	 * }
	 * </pre>
	 ...
	 * <pre>
	 * {@code
	 * ServerResourceLoaderEvents.START_RESOURCE_RELOAD.register((resourceManager, context) -> {
	 * 	...
	 * });
	 * }
	 * </pre>
	 ...
	 * <pre>
	 * {@code
	 * ServerResourceLoaderEvents.END_RESOURCE_RELOAD.register((resourceManager, context) -> {
	 * 	...
	 * });
	 * }
	 * </pre>
