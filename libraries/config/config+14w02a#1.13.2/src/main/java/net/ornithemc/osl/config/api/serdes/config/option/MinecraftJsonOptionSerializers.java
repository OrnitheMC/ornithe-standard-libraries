...
public class MinecraftJsonOptionSerializers {
	...
	public static final JsonOptionSerializer<IdentifierOption> IDENTIFIER = JsonOptionSerializers.register(IdentifierOption.class, new JsonOptionSerializer<IdentifierOption>() {
		...
		public void deserialize(IdentifierOption option, SerializationSettings settings, JsonFile json) throws IOException {
			option.set(new Identifier(json.readString()));
		}
	});
