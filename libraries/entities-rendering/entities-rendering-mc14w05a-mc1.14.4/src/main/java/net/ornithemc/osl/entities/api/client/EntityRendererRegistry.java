...
public interface EntityRendererRegistry {
	 ...
	 */
	<T extends Entity> void register(Class<T> type, Function<EntityRenderDispatcher, EntityRenderer<? super T>> factory);
	 ...
	 * {@linkplain #register(Class, Function)} impossible without special patches to
	 ...
	 * @param factory the factory for the entity renderer to register.
	 * 
	 * @deprecated use {@linkplain #register(Class, Function)} if possible
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Deprecated
	default <T extends Entity> void registerUnsafe(Class<T> type, Function<EntityRenderDispatcher, EntityRenderer> factory) {
		this.register(type, (Function) factory);
	}
}
