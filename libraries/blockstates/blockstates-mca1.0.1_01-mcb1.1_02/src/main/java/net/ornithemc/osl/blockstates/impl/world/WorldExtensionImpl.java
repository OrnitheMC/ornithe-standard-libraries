...
public interface WorldExtensionImpl extends WorldViewExtensionImpl, WorldExtension {
	...
	@Override
	default boolean setBlockState(BlockPos pos, BlockState state, boolean notify) {
		throw new AbstractMethodError();
	}

	@Override
	default boolean setBlockState(int x, int y, int z, BlockState state, boolean notify) {
		throw new AbstractMethodError();
	}
}
