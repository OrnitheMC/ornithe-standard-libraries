...
public class BlockStateImpl extends AbstractState<Block, BlockState> implements BlockState {
	...
	public boolean ticksRandomly() {
		return Block.TICKS_RANDOMLY[this.owner.id];
	}
	...
	public void dropItems(World world, BlockPos pos) {
		this.owner.dropItems(world, pos, this);
	}

	@Override
	public void dropItems(World world, BlockPos pos, float luck) {
		this.owner.dropItems(world, pos, this, luck);
	}
