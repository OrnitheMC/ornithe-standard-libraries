...
public interface BlockStateMixin extends BlockStateExtension {
	...
	@Override
	default boolean use(World world, BlockPos pos, PlayerEntity player, InteractionHand hand, Direction face, float faceX, float faceY, float faceZ) {
		return this.getBlock().use(world, pos, (BlockState) this, player, hand, face, faceX, faceY, faceZ);
	}
