...
public final class EntityTypeRegistry {
	 ...
	 * 
	 * @param identifier the identifier of entity type for which to register the spawn egg data
	 ...
	 * Registers spawn egg data for the specified entity type.
	 * 
	 * @param key        the resource key of entity type for which to register the spawn egg data
	 * @param baseColor  the base color of the spawn egg.
	 * @param spotsColor the color of the spots on the spawn egg.
	 */
