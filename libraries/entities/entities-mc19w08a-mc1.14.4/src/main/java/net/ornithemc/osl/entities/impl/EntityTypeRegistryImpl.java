...
public final class EntityTypeRegistryImpl {
	...
	public static final Registry<EntityType<?>> REGISTRY = VanillaRegistries.registerSimple(RegistryKeys.ENTITY_TYPE, net.minecraft.util.registry.Registry.ENTITY_TYPE);
